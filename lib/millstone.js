    ...
    Step(function setup() {
        ...
        resolved.Layer.forEach(function(l, index) {
            ...
            var symlink = function(file, cb) {
                ...
                var forcefile = copy ? utils.copy : utils.forcelink;
                    ...
                    case '.zip':
                        ...
                        path.exists(l.Datasource.file, function(exists) {
                            ...
                            unzip(file, function(err, file) {
                                ...
                                utils.processSHP(file, l.Datasource.file, forcefile, cb);
                            });
                        });
                        break;
                    // Symlink directories
                ...
                Step(function() {
                    ...
                    for (var i = 0; i < dbs.length; i++) (function(next) {
                        ...
                        var symlink = function(filepath, cb) {
                            ...
                            if (copy) utils.copy(filepath, filename, cb);
                            else utils.forcelink(filepath, filename, cb);
                        };
